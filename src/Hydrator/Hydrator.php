 ...
 * @license
 */
namespace Pacificnm\Acl\Hydrator;
...
class Hydrator extends ClassMethods
{
    ...
    public function hydrate(array $data, $object)
    {
        ...
        $resourceEntity = parent::hydrate($data, new \Pacificnm\AclResource\Entity\Entity());
        
        $object->setResourceEntity($resourceEntity);
        
        $roleEntity = parent::hydrate($data, new \Pacificnm\AclRole\Entity\Entity());
